...
BurgerItem::BurgerItem(int location) {
  ...
  switch (location) {
  case kLeftDown:
    x_ = burger_constants::kXStartLeft;
    y_ = burger_constants::kYStartDown;
    break;
  case kLeftMid:
    x_ = burger_constants::kXStartLeft;
    y_ = burger_constants::kYStartMid;
    break;
  case kLeftUp:
    x_ = burger_constants::kXStartLeft;
    y_ = burger_constants::kYStartUp;
    break;

  case kRightDown:
    x_ = burger_constants::kXStartRight;
    y_ = burger_constants::kYStartDown;
    break;
  case kRightMid:
    x_ = burger_constants::kXStartRight;
